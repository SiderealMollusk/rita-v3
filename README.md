...
- Script: `scripts/ansible_prepare_edge_vms.sh`
- Playbook: `ops/newt_install/ansible/playbooks/prepare_edge_vms.yml`
- Script: `scripts/ansible_snapshot_edge_vms.sh`
- Playbook: `ops/newt_install/ansible/playbooks/snapshot_edge_vms.yml`
- VM inventory scaffold: `ops/newt_install/ansible/inventory/edge_vms.ini`
